...
- `@takuyaw-w/a5sql-mcp-parser`
- `@takuyaw-w/a5sql-mcp-core`
- `@takuyaw-w/a5sql-mcp`

Trusted Publisher の設定値:

- Publisher: GitHub Actions
- Organization or user: `takuyaw-w`
- Repository: `a5sql-mcp`
...
workflow は `packages/parser`, `packages/core`, `packages/cli` の version がすべて同じで、tag 名が `v<version>` と一致する場合だけ publish します。
