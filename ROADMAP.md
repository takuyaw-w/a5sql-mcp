...
- 失敗が見つかり大きな修正が必要な場合は、0.10.4 に混ぜず 0.10.5 を切る。
...
9. 0.10.4 で 1.0.0 final RC dry run を行う。

次点:

1. final RC で見つかった release blocking regression のみを 0.10.5 以降に切り出す。
